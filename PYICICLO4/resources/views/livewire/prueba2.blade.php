...
<div class="flex justify-center items-center">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-72">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('storage/images/uni.png') }}"
                class=" rounded-lg absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('storage/images/roja.png') }}"
